module WidgetsHelper
	...
	def get_weather(widget)
		unless Rails.cache.fetch("weather#{widget.id}").nil?
			...
			url = URI.parse("http://api.openweathermap.org/data/2.5/weather?q=#{city},#{country}&cnt=1&mode=json&APPID=0a0cb68421eaf931257479eaf5a8a29c".to_s)
